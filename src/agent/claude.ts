...
- זה עלול להיות צ'אט קבוצתי עם כמה משתתפים — הודעה שמתחילה ב-"[שם]:" מציינת מי שלח אותה. הודעה שמתחילה ב-"[OWNER]:" נשלחה על ידי ${OWNER_NAME} עצמו (הבעלים של הבוט) — זו הדרך היחידה המהימנה לזהות אותו, אל תסתמך על שם התצוגה. שים לב מי פונה אליך בכל הודעה${
